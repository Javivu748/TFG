...
Route::middleware(['auth', 'es.admin'])->group(function () {
    ...
    Route::post('/admin/usuarios/{id}/convertir-administrador', [AdminController::class, 'cambiarRolAdmin'])->name('admin.usuario.convertir.administrador');
    Route::post('/admin/usuarios/{id}/convertir-usuario', [AdminController::class, 'cambiarRolUser'])->name('admin.usuario.convertir.usuario');
});
